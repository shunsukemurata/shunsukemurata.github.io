...
国際比較研究と国内での地域間比較を通じて、長寿および健康的な老化の決定要因を探索しています。現在進行中の研究プロジェクトとして、日本とスウェーデンにおける高齢者の健康状態と医療の比較研究、および日本国内における健康寿命の地域差に関する研究を実施しています。

::: {style="font-size: 1.3rem;"}
**高齢者の健康課題、特に認知症**
:::

高齢者のQOLと自立に影響を与える健康上・安全上の重要課題について研究しています。認知症や筋骨格系疼痛などの慢性疾患が障害や認知機能に及ぼす影響、認知症に関連する行方不明や徘徊行動といった安全リスクなどを対象としています。

特に力を入れているのが認知症研究であり、疾患の進行過程の解明と、認知症とともに生きる人々へのケア提供の最適化を目指しています。これらの研究は、認知症ケア戦略、介護者支援、保健医療政策に重要な示唆を提供します。
...
[**日本学術振興会 特別研究員制度（PD）東北大学ページ**](https://c.bureau.tohoku.ac.jp/kensui-top/3jsps/){target="_blank"}
